...
public class AsyncLoader32 {
// Callbacks that are pending
private static AsyncLoader32__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader32__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader32 instance = null;
public static void onLoad() {
instance = new AsyncLoader32();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(32);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks32", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks32", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader32__Callback newCallback = new AsyncLoader32__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(32)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(32,
...
while (callbacksHead != null) {
  ...
  AsyncLoader32__Callback next = callbacksHead;
