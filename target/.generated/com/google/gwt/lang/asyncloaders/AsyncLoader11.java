...
public class AsyncLoader11 {
// Callbacks that are pending
private static AsyncLoader11__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader11__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader11 instance = null;
public static void onLoad() {
instance = new AsyncLoader11();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(11);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks11", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks11", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader11__Callback newCallback = new AsyncLoader11__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(11)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(11,
...
while (callbacksHead != null) {
  ...
  AsyncLoader11__Callback next = callbacksHead;
