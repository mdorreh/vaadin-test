...
public class AsyncLoader13 {
// Callbacks that are pending
private static AsyncLoader13__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader13__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader13 instance = null;
public static void onLoad() {
instance = new AsyncLoader13();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(13);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks13", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks13", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader13__Callback newCallback = new AsyncLoader13__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(13)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(13,
...
while (callbacksHead != null) {
  ...
  AsyncLoader13__Callback next = callbacksHead;
