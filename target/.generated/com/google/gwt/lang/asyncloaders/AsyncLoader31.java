...
public class AsyncLoader31 {
// Callbacks that are pending
private static AsyncLoader31__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader31__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader31 instance = null;
public static void onLoad() {
instance = new AsyncLoader31();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(31);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks31", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks31", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader31__Callback newCallback = new AsyncLoader31__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(31)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(31,
...
while (callbacksHead != null) {
  ...
  AsyncLoader31__Callback next = callbacksHead;
