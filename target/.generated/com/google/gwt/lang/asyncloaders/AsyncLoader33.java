...
public class AsyncLoader33 {
// Callbacks that are pending
private static AsyncLoader33__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader33__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader33 instance = null;
public static void onLoad() {
instance = new AsyncLoader33();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(33);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks33", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks33", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader33__Callback newCallback = new AsyncLoader33__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(33)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(33,
...
while (callbacksHead != null) {
  ...
  AsyncLoader33__Callback next = callbacksHead;
