...
public class AsyncLoader18 {
// Callbacks that are pending
private static AsyncLoader18__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader18__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader18 instance = null;
public static void onLoad() {
instance = new AsyncLoader18();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(18);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks18", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks18", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader18__Callback newCallback = new AsyncLoader18__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(18)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(18,
...
while (callbacksHead != null) {
  ...
  AsyncLoader18__Callback next = callbacksHead;
