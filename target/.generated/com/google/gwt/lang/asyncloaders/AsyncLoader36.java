...
public class AsyncLoader36 {
// Callbacks that are pending
private static AsyncLoader36__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader36__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader36 instance = null;
public static void onLoad() {
instance = new AsyncLoader36();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(36);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks36", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks36", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader36__Callback newCallback = new AsyncLoader36__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(36)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(36,
...
while (callbacksHead != null) {
  ...
  AsyncLoader36__Callback next = callbacksHead;
