...
public class AsyncLoader24 {
// Callbacks that are pending
private static AsyncLoader24__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader24__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader24 instance = null;
public static void onLoad() {
instance = new AsyncLoader24();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(24);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks24", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks24", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader24__Callback newCallback = new AsyncLoader24__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(24)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(24,
...
while (callbacksHead != null) {
  ...
  AsyncLoader24__Callback next = callbacksHead;
