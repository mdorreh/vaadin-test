...
public class AsyncLoader10 {
// Callbacks that are pending
private static AsyncLoader10__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader10__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader10 instance = null;
public static void onLoad() {
instance = new AsyncLoader10();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(10);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks10", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks10", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader10__Callback newCallback = new AsyncLoader10__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(10)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(10,
...
while (callbacksHead != null) {
  ...
  AsyncLoader10__Callback next = callbacksHead;
