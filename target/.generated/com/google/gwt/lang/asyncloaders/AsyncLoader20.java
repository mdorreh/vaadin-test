...
public class AsyncLoader20 {
// Callbacks that are pending
private static AsyncLoader20__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader20__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader20 instance = null;
public static void onLoad() {
instance = new AsyncLoader20();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(20);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks20", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks20", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader20__Callback newCallback = new AsyncLoader20__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(20)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(20,
...
while (callbacksHead != null) {
  ...
  AsyncLoader20__Callback next = callbacksHead;
