...
public class AsyncLoader17 {
// Callbacks that are pending
private static AsyncLoader17__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader17__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader17 instance = null;
public static void onLoad() {
instance = new AsyncLoader17();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(17);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks17", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks17", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader17__Callback newCallback = new AsyncLoader17__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(17)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(17,
...
while (callbacksHead != null) {
  ...
  AsyncLoader17__Callback next = callbacksHead;
