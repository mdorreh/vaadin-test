...
public class AsyncLoader14 {
// Callbacks that are pending
private static AsyncLoader14__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader14__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader14 instance = null;
public static void onLoad() {
instance = new AsyncLoader14();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(14);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks14", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks14", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader14__Callback newCallback = new AsyncLoader14__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(14)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(14,
...
while (callbacksHead != null) {
  ...
  AsyncLoader14__Callback next = callbacksHead;
