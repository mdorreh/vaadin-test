...
public class AsyncLoader34 {
// Callbacks that are pending
private static AsyncLoader34__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader34__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader34 instance = null;
public static void onLoad() {
instance = new AsyncLoader34();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(34);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks34", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks34", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader34__Callback newCallback = new AsyncLoader34__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(34)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(34,
...
while (callbacksHead != null) {
  ...
  AsyncLoader34__Callback next = callbacksHead;
