...
public class AsyncLoader19 {
// Callbacks that are pending
private static AsyncLoader19__Callback callbacksHead = null;
// The tail of the callbacks list
private static AsyncLoader19__Callback callbacksTail = null;
// A callback caller for this entry point
private static AsyncLoader19 instance = null;
public static void onLoad() {
instance = new AsyncLoader19();
AsyncFragmentLoader.BROWSER_LOADER.fragmentHasLoaded(19);
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks19", "begin");
instance.runCallbacks();
AsyncFragmentLoader.BROWSER_LOADER.logEventProgress("runCallbacks19", "end");
}
public static void runAsync(RunAsyncCallback callback) {
AsyncLoader19__Callback newCallback = new AsyncLoader19__Callback();
...
if (!AsyncFragmentLoader.BROWSER_LOADER.isLoading(19)) {
  AsyncFragmentLoader.BROWSER_LOADER.inject(19,
...
while (callbacksHead != null) {
  ...
  AsyncLoader19__Callback next = callbacksHead;
